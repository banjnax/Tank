...
public class MyTank2 extends TankClass{
	...
	public MyTank2(int x, int y,int speed,boolean good) {
		super(x,y,speed,good);
	}
	public MyTank2(int x,int y,int speed,boolean good,TankServer t){
	...
	public void paint(Graphics g){
		...
		g.drawString("Player"+SNum,x,y);
		bb.drawBB(g);
		if(good){
				g.fillRect(x, y, WIDTH+20, HEIGHT+20);
				g.drawLine(x+50, y+5, x+55, y+5);
				g.fillRect(x+50, y+10, 20, 30);
				g.drawLine(x+50, y+45, x+55, y+45);
			}
		else {
	...
	//	t.bullets.add(new bullet(bx,by,ptDir,good,this.t));
		...
		t.bullets.add(new bullet(x+53,y+2,Direction.R,good,this.t));
		t.bullets.add(new bullet(x+53,y+42,Direction.R,good,this.t));
		}
		t.bullets.add(new bullet(x+53,y+20,Direction.R,good,this.t));
	//	t.bullets.add(new bullet(x+53,y+33,Direction.R,good,this.t));
